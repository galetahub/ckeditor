(function(){
  CKEDITOR.dialog.add('attachment',
    function(editor){
      ...
      return { title:editor.lang.attachment.title,
               minWidth:420,
               minHeight:200,
               onShow: function(){
                        this.fakeObj=false;
               ...
               onOk:function(){
                var attributes={href:'javascript:void(0)/*'+CKEDITOR.tools.getNextNumber()+'*/'},
                    ...
                    if(data.target){
                      ...
                      else removeAttributes.push('target');removeAttributes.push('_cke_pa_onclick','onclick')
                    }
