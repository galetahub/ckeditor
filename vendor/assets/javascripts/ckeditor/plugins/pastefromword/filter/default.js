        ...
        r = new CKEDITOR.htmlParser.filter({
            ...
            elements: {
                ...
                p: function(a) {
                    ...
                    if (f.thisIsAListItem(b, a)) f.convertToFakeListItem(b, a);
                    else {
                ...
                td: function(a) {
                    var b = a.getAscendant("table"),
                        c = b._tdBorders,
                        d = ["border", "border-top", "border-right", "border-bottom", "border-left"],
                        b = l.parseCssText(b.attributes.style),
                        e = b.background || b.BACKGROUND;
                    e && k.setStyle(a,
                        "background", e, !0);
    ...
    CKEDITOR.plugins.pastefromword.styles = {
        ...
        pushStylesLower: function(a, b) {
            ...
            var c = {
                ...
                e;
            for (e in d)
                if (!(e.toLowerCase() in c || c[e.toLowerCase().replace(/\-.*$/, "-")] || e.toLowerCase() in b)) {
    ...
    CKEDITOR.plugins.pastefromword.lists = {
            ...
            toNumber: function(a, b) {
                ...
                function d(a) {
                    ...
                    for (var c = b.length, d = 0, f = 0; f < c; ++f)
                        for (var n = b[f], p = n[1].length; a.substr(0, p) == n[1]; a = a.substr(p)) d +=
                            n[0];
                    return d
                }
            ...
            for (a = 0; a < h.length; a++) {
                ...
                for (d = 0; d < g.length; d++) {
                    ...
                    for (c = b.attributes["cke-list-level"]; c > m.length;) {
                        var p = f.createList(b),
                            l = k.children;
                        0 < l.length ? l[l.length - 1].add(p) : (l = new CKEDITOR.htmlParser.element("li", {
        ...
        chopDiscontinuousLists: function(a, b) {
            for (var c = {}, d = [
                ...
                var g = c[a[h].attributes["cke-list-level"]],
                    k = this.getListItemInfo(a[h]),
                    q, n;
        ...
        getListItemInfo: function(a) {
            ...
            var b = l.parseCssText(a.attributes.style)["mso-list"],
                c = {
                    id: "0",
                    level: "1"
                };
